            ...
            <div>
              ...
              <div className="mt-1">
                <input type="text"
                  ...
                  className="appeareance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className='mt-2 flex items-center'>
                ...
                <label htmlFor="file-input"
                  ...
                  <input type="file" name="avatar" id="file-input" accept='.jpeg,.jpg,.png' onChange={handleFileInput}
                    className='sr-only' />
                </label>
              </div>
            </div>
